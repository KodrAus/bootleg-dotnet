...
mkdir -p /dotnet/src/sdk/ilc
cp -r /dotnet/src/platform/corert/bin/Linux.x64.Debug/tools/* /dotnet/src/sdk/ilc

ilc /dotnet/src/sdk/ilc/ilc.dll -o:/dotnet/src/sdk/ilc/ilc.o \
  -r:/dotnet/src/sdk/ilc/ILCompiler.Compiler.dll \
  -r:/dotnet/src/sdk/ilc/ILCompiler.CppCodeGen.dll \
  -r:/dotnet/src/sdk/ilc/ILCompiler.DependencyAnalysisFramework.dll \
  -r:/dotnet/src/sdk/ilc/ILCompiler.MetadataTransform.dll \
  -r:/dotnet/src/sdk/ilc/ILCompiler.MetadataWriter.dll \
  -r:/dotnet/src/sdk/ilc/ILCompiler.RyuJit.dll \
  -r:/dotnet/src/sdk/ilc/ILCompiler.TypeSystem.dll \
  -r:/dotnet/src/sdk/ilc/ILCompiler.WebAssembly.dll \
  -r:/dotnet/src/sdk/ilc/Microsoft.DiaSymReader.dll \
  -r:/dotnet/src/sdk/ilc/Microsoft.DiaSymReader.dll \
  -r:/dotnet/src/sdk/ilc/LLVMSharp.dll \
  -r:/dotnet/src/sdk/ilc/System.CommandLine.dll \
